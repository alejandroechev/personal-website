...
function createEngine(id, numBoids, numObstacles, sepForce, cohesionForce, alignForce, obstacleForce,
    separationRadius, cohesionRadius, alignmentRadius, obstacleRadius) {
